...
router.get('/fanpage-clicks/export-excel', middlewareController.verifyToken, checkRole('xem cuộc thi'), fanpage.exportExcel);
router.get('/fanpage-clicks/cuocthi-options', middlewareController.verifyToken, checkRole('xem cuộc thi'), fanpage.listCuocthiOptions);
router.get('/fanpage-clicks', middlewareController.verifyToken, checkRole('xem cuộc thi'), fanpage.listClicks);

const aichat = require('../controllers/aichat');
router.get('/ai-chat-logs/export-excel', middlewareController.verifyToken, checkRole('xem cuộc thi'), aichat.exportExcel);
router.get('/ai-chat-logs', middlewareController.verifyToken, checkRole('xem cuộc thi'), aichat.listLogs);
...
router.get('/thongke-cau-hoi-sai', middlewareController.verifyToken, checkRole('xem cuộc thi'), monthi.thongKeCauHoiSaiTongHop);
